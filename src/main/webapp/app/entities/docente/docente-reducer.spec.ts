...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './docente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCENTE actions', async () => {
      const expectedActions = [
        {
