...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './curso.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURSO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CURSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CURSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CURSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CURSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CURSO actions', async () => {
      const expectedActions = [
        {
